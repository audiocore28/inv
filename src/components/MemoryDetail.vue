...
<template>
  <div>
    <div class="flex justify-between items-center p-2">
      <h1 class="font-oswald font-semibold text-md capitalize pb-1">{{ `${item.brand} ${formatSize(item.capacity)}` }}</h1>
    ...
    <div class="flex text-slate-500 pb-2">
      <span class="text-lime-500 inline-flex items-center gap-2 px-2 text-sm font-medium rounded-md transition-colors duration-200">
        ...
        <span class="font-inter text-xs uppercase">{{ item.gen }}</span>
      </span>
      ...
      <span v-if="item.rpm !== ''" class="inline-flex items-center gap-2 px-2 text-sm font-medium rounded-md transition-colors duration-200">
        ...
        <span class="font-inter text-xs">{{ item.speed }} mhz</span>
      </span>
    </div>
  </div>
</template>