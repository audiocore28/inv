  ...
  <div>
    ...
    <div class="flex text-slate-500 pb-2">
      <span class="text-yellow-500 inline-flex items-center gap-2 px-2 text-sm font-medium rounded-md transition-colors duration-200">
        <svg v-if="item.form === 'm.2'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-nvme-fill" viewBox="0 0 16 16" id="Nvme-Fill--Streamline-Bootstrap" height="16" width="16">
