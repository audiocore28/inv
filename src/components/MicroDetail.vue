  ...
  >
    <div class="flex justify-between items-center p-2">
      <h1 class="font-oswald font-semibold text-md capitalize pb-1">
        ...
        {{ ` ${item.model} ${item.series} ${item.formFactor}` }}
      </h1>
    ...
    <div class="flex flex-col gap-2 mt-2">
      <div class="flex flex-col gap-4 text-slate-500 pb-2">
        ...
        >
          ...
          <span class="font-inter text-xs">{{ `${memory.brand} ${formatSize(memory.capacity)} ${memory.gen} ${memory.speed}mhz` }}</span>
        </span>
      ...
      <div class="flex flex-col gap-4 text-slate-500 pb-2">
        ...
        >
          ...
          <span class="font-inter text-xs">{{ `${solid.brand} ${solid.series} ${formatSize(solid.capacity)} : ${solid.health}%` }}</span>
        </span>
      ...
      <div class="flex flex-col gap-4 text-slate-500 pb-2">
        ...
        >
          ...
          <span class="font-inter text-xs">{{ `${disk.brand} ${disk.model} ${formatSize(disk.capacity)} : ${disk.year} - ${disk.health}%` }}</span>
        </span>
