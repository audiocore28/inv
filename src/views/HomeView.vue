...
<template>
  ...
  <div>
    <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 md:p-16 2xl:p-28">
      ...
      <div class="mt-10 text-slate-500 text-sm uppercase font-semibold font-oswald">
        <div class="mb-5">
          <div class="flex inline-flex justify-center items-center gap-2">
            <svg 
              :class="{
                'text-white' : microStore.brand === 'all',
                'text-sky-500' : microStore.brand === 'Dell',
                'text-rose-500' : microStore.brand === 'Lenovo',
                'text-gray-500' : microStore.brand === 'HP',
              }"
              class="w-4 h-4" width="64px" height="64px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            >
          ...
          <Group :count="microStore.availableMicros.length" :groups="microStore.brands" :group="microStore.brand" @changeGroup="microStore.brand = $event" :category="'micro'" :groupBy="'brand'"/>
        </div>
        <div class="mb-5">
          <div class="flex inline-flex justify-center items-center gap-2">
