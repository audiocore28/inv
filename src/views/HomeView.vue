    ...
    <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 md:p-16 2xl:p-28">
      ...
      <div class="mt-10 text-slate-500 text-sm uppercase font-semibold font-oswald">
        <div class="mb-5">
          ...
          <Group :count="memoryStore.memories.length" :groups="memoryStore.capacities" :group="memoryStore.capacity" @changeGroup="memoryStore.capacity = $event" />
        </div>
        <div class="mb-5">
          ...
          <Group :count="solidStore.solids.length" :groups="solidStore.capacities" :group="solidStore.capacity" @changeGroup="solidStore.capacity = $event" />
        </div>
        <div class="mb-5">
          ...
          <Group :count="diskStore.disks.length" :groups="diskStore.capacities" :group="diskStore.capacity" @changeGroup="diskStore.capacity = $event" />
        </div>
      </div>
    </div>
