    ...
    <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 md:p-16 2xl:p-28">
      ...
      <div class="text-slate-500 text-sm uppercase font-semibold font-oswald">
        <div class="mb-5">
          ...
          <Group :count="processorStore.availableProcessors.length" :groups="processorStore.groups" :group="processorStore.gen" @changeGroup="processorStore.gen = $event" :category="'cpu'" />
        </div>
        ...
        <div class="mb-5">
          ...
          <Group :count="memoryStore.availableMemories.length" :groups="memoryStore.groups" :group="memoryStore.capacity" @changeGroup="memoryStore.capacity = $event" :category="'ram'" />
        </div>
        <div class="mb-5">
          <div class="flex inline-flex justify-center items-center gap-2">
          ...
          <Group :count="solidStore.availableSolids.length" :groups="solidStore.groups" :group="solidStore.capacity" @changeGroup="solidStore.capacity = $event" :category="'ssd'" />
        </div>
        <div class="mb-5">
          <div class="flex inline-flex justify-center items-center gap-2">
          ...
          <Group :count="diskStore.availableDisks.length" :groups="diskStore.groups" :group="diskStore.capacity" @changeGroup="diskStore.capacity = $event" :category="'hdd'" />
        </div>
      </div>
    </div>
  </div>
